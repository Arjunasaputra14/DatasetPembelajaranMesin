...
if st.button("Predict Stroke"):
    st.write("Tombol diklik, memulai prediksi...") # Debugging line
    ...
    st.write("DataFrame input dibuat.") # Debugging line
    ...
    st.write("Input di-encode.") # Debugging line
    ...
    st.write("Missing columns ditangani dan input di-reindex.") # Debugging line
    ...
    if 'avg_glucose_level_log' in train_cols and 'avg_glucose_level' in user_input:
         ...
         if 'avg_glucose_level' in input_processed.columns:
            st.write("Menerapkan log transformation ke avg_glucose_level.") # Debugging line
            ...
            st.write("Log transformation dan dropping avg_glucose_level selesai.") # Debugging line
    ...
    st.write(f"Kolom numerik untuk scaling: {numerical_cols_to_scale}") # Debugging line
    st.write("Menerapkan scaling ke kolom numerik.") # Debugging line
    ...
    st.write("Scaling selesai.") # Debugging line


    # Make prediction
    st.write("Membuat prediksi...") # Debugging line
    ...
    st.write("Prediksi selesai.") # Debugging line
